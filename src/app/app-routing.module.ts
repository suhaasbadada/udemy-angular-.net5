...
const routes: Routes = [
  ...
  {path:'movie-theaters',component:IndexMovieTheaterComponent,canActivate:[IsAdminGuard]},
  {path:'movie-theaters/create',component:CreateMovieTheaterComponent,canActivate:[IsAdminGuard]},
  {path:'movie-theaters/edit/:id',component:EditMovieTheaterComponent,canActivate:[IsAdminGuard]},
